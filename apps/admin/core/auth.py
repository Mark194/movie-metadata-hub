        ...
        try:
            with httpx.Client(timeout=self.timeout) as client:
                ...
                if response.status_code == HTTPStatus.OK:
                    ...
                    logger.warning(
                        LOGIN_FAILED, login, response.status_code, response.text
                    )
                    return None
        ...
        try:
            with httpx.Client(timeout=self.timeout) as client:
                ...
                if response.status_code >= HTTPStatus.BAD_REQUEST:
                    logger.warning(LOGOUT_FAILED, response.status_code, response.text)
        except httpx.TimeoutException:
        ...
        try:
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                ...
                if response.status_code == HTTPStatus.OK:
                    ...
                    logger.warning(REFRESH_TOKEN, response.status_code, response.text)
                    return None
        except httpx.TimeoutException:
