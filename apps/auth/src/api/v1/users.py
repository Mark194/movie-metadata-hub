...
async def change_login(
    ...
    try:
        updated_user = await service.change_login(
            current_user.id, params.new_login, params.password
        )
...
async def change_password(
    ...
    try:
        await service.change_password(
            current_user.id, params.old_password, params.new_password
        )
...
async def remove_role_from_user(
    ...
    try:
        ...
        raise HTTPException(
            status_code=HTTPStatus.BAD_REQUEST, detail=INVALID_USER_OR_ROLE
        )
