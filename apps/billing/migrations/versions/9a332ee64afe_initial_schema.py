...
def upgrade() -> None:
    ...
    sa.Column('discount_type', sa.Enum('PERCENT', 'FIXED', 'FREE_TRIAL', name='discounttype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'EXPIRED', 'DISABLED', name='promocodestatus'), nullable=True),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'REVERTED', name='usagestatus'), nullable=True),
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('login_history_user_id_fkey'), ondelete='CASCADE'),
